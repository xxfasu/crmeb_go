...
type SystemStore struct {
	...
	ValidTime       int64                 `gorm:"column:valid_time;type:bigint;not null;comment:核销有效日期" json:"valid_time"`                 // 核销有效日期
	DayTime         int64                 `gorm:"column:day_time;type:bigint;not null;comment:每日营业开关时间" json:"day_time"`                   // 每日营业开关时间
