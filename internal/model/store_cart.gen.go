...
type StoreCart struct {
	...
	IsNew             bool                  `gorm:"column:is_new;type:tinyint(1);not null;comment:是否为立即购买" json:"is_new"`                         // 是否为立即购买
	...
	Status            bool                  `gorm:"column:status;type:tinyint(1);not null;default:1;comment:购物车状态" json:"status"`                 // 购物车状态
