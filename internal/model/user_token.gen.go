...
type UserToken struct {
	...
	Type        bool                  `gorm:"column:type;type:tinyint(1);default:1;comment:类型，1 公众号， 2 小程序, 3 unionid, 5AppIos,6AppAndroid,7ios" json:"type"` // 类型，1 公众号， 2 小程序, 3 unionid, 5AppIos,6AppAndroid,7ios
