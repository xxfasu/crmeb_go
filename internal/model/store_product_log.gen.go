...
type StoreProductLog struct {
	...
	VisitNum    bool                  `gorm:"column:visit_num;type:tinyint(1);not null;comment:是否浏览" json:"visit_num"`                         // 是否浏览
	...
	CollectNum  bool                  `gorm:"column:collect_num;type:tinyint(1);not null;comment:收藏" json:"collect_num"`                       // 收藏
